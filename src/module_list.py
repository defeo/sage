...
ext_modules = [
    ...
    Extension('sage.rings.ff_compositum.wrappers',
              sources = ['sage/rings/ff_compositum/wrappers.pyx',
                         'sage/rings/ff_compositum/compositum_embedding.c',
                         'sage/rings/ff_compositum/compositum_isomorphism_2.c',
                         'sage/rings/ff_compositum/compositum_isomorphism.c',
                         'sage/rings/ff_compositum/compositum_tisomorphism_2.c',
                         'sage/rings/ff_compositum/compositum_isomorphism_matrix.c',
                         'sage/rings/ff_compositum/compositum_utils.c',
                         'sage/rings/ff_compositum/nmod_poly_convert_from_trace.c',
                         'sage/rings/ff_compositum/nmod_poly_from_newton_sums.c',
                         'sage/rings/ff_compositum/nmod_poly_inverse_reverse.c',
                         'sage/rings/ff_compositum/nmod_poly_mat_right_tmul.c',
                         'sage/rings/ff_compositum/nmod_poly_minimal_polynomial_sequence.c',
                         'sage/rings/ff_compositum/nmod_poly_ratrecon.c',
                         'sage/rings/ff_compositum/nmod_poly_tmul.c',
                         'sage/rings/ff_compositum/nmod_poly_tmulmod.c',
